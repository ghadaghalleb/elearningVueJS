            ...
            <div class="row d_flex">
               <div class="col-md-7">
                  <div class="titlepage">
                     ...
                     <span></span>
                     <p>Lancez-vous dans le domaine en pleine croissance de la gestion de projet 
               ...
               <div class="col-md-5">
                  <div class="about_img">
                     <figure>
                       <img src="https://storage.googleapis.com/grow-with-goog-publish-prod-media/images/project-management-hero.scale-100.png"
                      alt="#"/>
                      </figure>
                  </div>
               </div>
